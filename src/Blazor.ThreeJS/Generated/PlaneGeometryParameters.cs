...
/// <summary>
/// The shape three.js calls <c>PlaneGeometryParameters</c>. A plain value rather than a
...
/// </summary>
public sealed record PlaneGeometryParameters : IThreeStructure
{
	...
	/// <summary>
	/// Builds a <c>PlaneGeometryParameters</c> from the members the applier sent back. A member
