...
Generated from `@types/three@0.185.3`: **195 of three.js's 309 core classes** and
**41** of its constant groups, carrying 1754 public members and 252 enum members. Property names,
...
one of those 195 classes - its command and query surface is emitted as the other half of a
`partial class`. So `Generated/**` carries 1788 public members in all, and this headline claims
only the ones that sit on a class the generator made.

A further 69 classes have no generated type and are still **reachable** untyped, by name -
...
|---|---|
| **generated** | **195** |
| blocked on something the mirror cannot express yet | 54 |
...
| obstacle | classes |
|---|---|
| its C# base requires constructor arguments the generated class has nothing to supply | 16 |
...
- **48 members typed as a DOM or TypeScript lib type** - C# holds no `HTMLCanvasElement` to hand over,
...
The 54 blocked classes account for themselves as follows:
...
- **15 are absent from the shipped three.js bundle.** Not a mapping decision: `THREE[name]` is
  ...
  escape hatch either.
- **26 lose no capability**, listed below. They are abstract bases whose concrete subclasses all
...
- **52 of the 195 generated classes have a narrower constructor.** 93 trailing optional parameters
...
| | classes |
|---|---|
| **generated, and typed** | **195** |
| reachable by name, untyped | 69 |
