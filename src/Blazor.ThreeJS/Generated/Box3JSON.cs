...
/// <summary>
/// The shape three.js calls <c>Box3JSON</c>. A plain value rather than a handle-backed object:
...
/// </summary>
public sealed record Box3JSON : IThreeStructure
{
	/// <summary>three.js's <c>min</c>.</summary>
	public float[] Min { get; init; }

	/// <summary>three.js's <c>max</c>.</summary>
	...
	/// <summary>
	/// Builds a <c>Box3JSON</c> from the members the applier sent back. A member three.js did not carry
