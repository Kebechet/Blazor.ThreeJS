...
/// <summary>
/// Interpolant that evaluates to the sample value at the position preceding the parameter. The
/// JavaScript-side <c>THREE.DiscreteInterpolant</c>.
/// </summary>
public sealed class DiscreteInterpolant : ThreeObject
{
	...
	/// <summary>Initializes a new <see cref="DiscreteInterpolant"/>.</summary>
	...
	/// <summary>
	/// Adopts an existing JavaScript-side <c>DiscreteInterpolant</c> under the handle the browser
	/// minted for it. No create op is emitted: the object already exists, and this mirror's job is to
	/// name it.
	/// </summary>
	/// <param name="batch">Batch this object's writes record into.</param>
	/// <param name="handle">Negative handle the JavaScript side registered the object under.</param>
	internal DiscreteInterpolant(ThreeBatch batch, int handle)
		: base(handle)
	{
	...
	/// <summary>Name of the corresponding three.js constructor, <c>THREE.DiscreteInterpolant</c>.</summary>
	protected override string ThreeTypeName
	{
		get { return "DiscreteInterpolant"; }
	}

	/// <summary>
	/// Constructor arguments forwarded to <c>THREE.DiscreteInterpolant</c>: parameterPositions,
	...
	public Task<TypedArray> Interpolate_Async(float i1)
	{
		return RecordRead<TypedArray>("interpolate_", i1);
	}
	...
	/// <summary>
	/// Emits the create op for <c>THREE.DiscreteInterpolant</c>, then replays every property written
