...
/// <summary>
/// The shape three.js calls <c>TorusGeometryJSON</c>. A plain value rather than a handle-backed
...
/// </summary>
public sealed record TorusGeometryJSON : IThreeStructure
{
	...
	/// <summary>
	/// Builds a <c>TorusGeometryJSON</c> from the members the applier sent back. A member three.js did
