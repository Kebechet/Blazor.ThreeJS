...
/// <summary>
/// Spherical linear unit quaternion interpolant. The JavaScript-side
/// <c>THREE.QuaternionLinearInterpolant</c>.
/// </summary>
public sealed class QuaternionLinearInterpolant : ThreeObject
{
	...
	/// <summary>Initializes a new <see cref="QuaternionLinearInterpolant"/>.</summary>
	...
	/// <summary>
	/// Adopts an existing JavaScript-side <c>QuaternionLinearInterpolant</c> under the handle the
	...
	internal QuaternionLinearInterpolant(ThreeBatch batch, int handle)
		: base(handle)
	{
	...
	/// <summary>Name of the corresponding three.js constructor, <c>THREE.QuaternionLinearInterpolant</c>.</summary>
	protected override string ThreeTypeName
	{
		get { return "QuaternionLinearInterpolant"; }
	}

	/// <summary>
	/// Constructor arguments forwarded to <c>THREE.QuaternionLinearInterpolant</c>: parameterPositions,
	...
	/// <summary>
	/// Emits the create op for <c>THREE.QuaternionLinearInterpolant</c>, then replays every property
