...
**44** of its constant groups, carrying 2216 public members and 263 enum members. Property names,
...
A further 35 public members are generated onto `Object3D`, which is hand-written and so is **not**
one of those 226 classes - its command and query surface is emitted as the other half of a
`partial class`. So `Generated/**` carries 2251 public members in all, and this headline claims
...
On the generated classes that reaches **533 members**:

- **425 answer with a value** - 240 methods (focal length and effective field of view, elapsed time,
...
- **97 answer with a mirrored object** - `Task<T?>` over the generated type, adopted under the handle the
...
- **2 members whose result is neither** - an array of objects, say, which would need a handle minted per
