...
/// <summary>
/// The shape three.js calls <c>BufferAttributeUpdateRanges</c>. A plain value rather than a
...
/// </summary>
public sealed record BufferAttributeUpdateRanges : IThreeStructure
{
	/// <summary>Position at which to start update.</summary>
	public float Start { get; init; }

	/// <summary>The number of components to update.</summary>
	...
	/// <summary>
	/// Builds a <c>BufferAttributeUpdateRanges</c> from the members the applier sent back. A member
	...
	{
		return new BufferAttributeUpdateRanges
		{
