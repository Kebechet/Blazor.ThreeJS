...
/// <summary>
/// Node material version of <see cref="LineDashedMaterial"/>. The JavaScript-side
/// <c>THREE.LineDashedNodeMaterial</c>.
/// </summary>
public sealed class LineDashedNodeMaterial : NodeMaterial
{
	...
	/// <summary>Constructs a new line dashed node material.</summary>
	public LineDashedNodeMaterial()
	{
	...
	/// <summary>
	/// Adopts an existing JavaScript-side <c>LineDashedNodeMaterial</c> under the handle the browser
	/// minted for it. No create op is emitted: the object already exists, and this mirror's job is to
	/// name it.
	/// </summary>
	/// <param name="batch">Batch this object's writes record into.</param>
	/// <param name="handle">Negative handle the JavaScript side registered the object under.</param>
	internal LineDashedNodeMaterial(ThreeBatch batch, int handle)
		: base(batch, handle)
	{
		Color = new Color(1f, 1f, 1f);
		Color.OnChange = () =>
	...
	/// <summary>Name of the corresponding three.js constructor, <c>THREE.LineDashedNodeMaterial</c>.</summary>
	protected override string ThreeTypeName
	{
		get { return "LineDashedNodeMaterial"; }
	}
	...
	/// </summary>
	/// <returns>The value <c>isLineDashedNodeMaterial</c> held, once the JavaScript side has answered.</returns>
	public Task<bool> IsLineDashedNodeMaterialAsync()
	{
		return GetAsync<bool>("isLineDashedNodeMaterial");
	}

	/// <summary>
	/// Emits the create op for <c>THREE.LineDashedNodeMaterial</c>, then replays every property written
