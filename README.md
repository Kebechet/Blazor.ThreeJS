...
**41** of its constant groups, carrying 1939 public members and 252 enum members. Property names,
...
`partial class`. So `Generated/**` carries 1973 public members in all, and this headline claims
...
On the generated classes that reaches **478 members**:

- **374 answer with a value** - 203 methods (focal length and effective field of view, elapsed time,
  curve lengths, instance matrices and colours, vertex positions, layer tests) and 171 read-only
...
- **93 answer with a mirrored object** - `Task<T?>` over the generated type, adopted under the handle the
