...
/// <summary>
/// The shape three.js calls <c>MorphTarget</c>. A plain value rather than a handle-backed object:
...
/// </summary>
public sealed record MorphTarget : IThreeStructure
{
	...
	/// <summary>
	/// Builds a <c>MorphTarget</c> from the members the applier sent back. A member three.js did not
