...
/// <summary>The JavaScript-side <c>THREE.NodeObjectLoader</c>.</summary>
public sealed class NodeObjectLoader : ObjectLoader
{
	...
	/// <summary>
	/// Adopts an existing JavaScript-side <c>NodeObjectLoader</c> under the handle the browser minted
	...
	internal NodeObjectLoader(ThreeBatch batch, int handle)
		: base(batch, handle)
	{
		Batch = batch;
	}

	/// <summary>Name of the corresponding three.js constructor, <c>THREE.NodeObjectLoader</c>.</summary>
	protected override string ThreeTypeName
	{
		get { return "NodeObjectLoader"; }
	}

	/// <summary>
	/// Constructor arguments forwarded to <c>THREE.NodeObjectLoader</c>: manager. An argument the
