...
/// <summary>
/// Class for loading a texture. Unlike other loaders, this one emits events instead of using
/// predefined callbacks. So if you're interested in getting notified when things happen, you need
/// to add listeners to the object. The JavaScript-side <c>THREE.TextureLoader</c>.
/// </summary>
public sealed class TextureLoader : Loader
{
	...
	/// <summary>
	/// Adopts an existing JavaScript-side <c>TextureLoader</c> under the handle the browser minted for
	/// it. No create op is emitted: the object already exists, and this mirror's job is to name it.
	/// </summary>
	/// <param name="batch">Batch this object's writes record into.</param>
	/// <param name="handle">Negative handle the JavaScript side registered the object under.</param>
	internal TextureLoader(ThreeBatch batch, int handle)
		: base(batch, handle)
	{
		Batch = batch;
	}

	/// <summary>Name of the corresponding three.js constructor, <c>THREE.TextureLoader</c>.</summary>
	...
	/// <summary>
	/// Constructor arguments forwarded to <c>THREE.TextureLoader</c>: manager. An argument the caller
	...
	/// <summary>
	/// Attaches the objects <c>THREE.TextureLoader</c> is constructed from, so their create ops reach
