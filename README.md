...
**47** of its constant groups, carrying 2283 public members and 294 enum members. Property names,
...
`partial class`. So `Generated/**` carries 2320 public members in all, and this headline claims
...
On the generated classes that reaches **549 members**:

- **434 answer with a value** - 248 methods (focal length and effective field of view, elapsed time,
...
- **58 of the 226 generated classes have a narrower constructor.** 104 trailing optional parameters
