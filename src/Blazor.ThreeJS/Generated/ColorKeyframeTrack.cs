...
/// <summary>A track for color keyframe values. The JavaScript-side <c>THREE.ColorKeyframeTrack</c>.</summary>
public sealed class ColorKeyframeTrack : ThreeObject
{
	...
	/// <summary>Constructs a new color keyframe track.</summary>
	...
	public ColorKeyframeTrack(string name, float[] times, float[] values, InterpolationModes? interpolation = null)
	{
		_name = name;
		_times = times;
		_values = values;
	...
	/// <summary>
	/// Adopts an existing JavaScript-side <c>ColorKeyframeTrack</c> under the handle the browser minted
	...
	internal ColorKeyframeTrack(ThreeBatch batch, int handle)
		: base(handle)
	{
		_name = default!;
		_times = default!;
	...
	/// <summary>Name of the corresponding three.js constructor, <c>THREE.ColorKeyframeTrack</c>.</summary>
	protected override string ThreeTypeName
	{
		get { return "ColorKeyframeTrack"; }
	}

	/// <summary>
	/// Constructor arguments forwarded to <c>THREE.ColorKeyframeTrack</c>: name, times, values,
	...
	public Task<ColorKeyframeTrack?> OptimizeAsync()
	{
		return RecordReadObject<ColorKeyframeTrack>("optimize", (adoptedBatch, adoptedHandle) => new ColorKeyframeTrack(adoptedBatch, adoptedHandle));
	}
	...
	public Task<ColorKeyframeTrack?> CloneAsync()
	{
		return RecordReadObject<ColorKeyframeTrack>("clone", (adoptedBatch, adoptedHandle) => new ColorKeyframeTrack(adoptedBatch, adoptedHandle));
	}

	/// <summary>
	/// Emits the create op for <c>THREE.ColorKeyframeTrack</c>, then replays every property written
