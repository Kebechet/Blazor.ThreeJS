...
**47** of its constant groups, carrying 2265 public members and 294 enum members. Property names,
...
`partial class`. So `Generated/**` carries 2302 public members in all, and this headline claims
...
On the generated classes that reaches **548 members**:

- **433 answer with a value** - 248 methods (focal length and effective field of view, elapsed time,
