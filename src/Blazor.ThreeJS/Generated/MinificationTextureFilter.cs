...
/// <summary>
/// Texture Minification Filter Modes. For use with a texture's <c>minFilter</c> property, these
/// define the texture minifying function that is used whenever the pixel being textured maps to an
/// area greater than one texture element (texel). Encoded on the wire as the numeric value three.js
/// itself uses, not as the member name.
/// </summary>
public enum MinificationTextureFilter : ushort
{
	/// <summary>
