...
/// <summary>
/// Node material version of <see cref="MeshMatcapMaterial"/>. The JavaScript-side
/// <c>THREE.MeshMatcapNodeMaterial</c>.
/// </summary>
public sealed class MeshMatcapNodeMaterial : NodeMaterial
{
	...
	/// <summary>
	/// Adopts an existing JavaScript-side <c>MeshMatcapNodeMaterial</c> under the handle the browser
	/// minted for it. No create op is emitted: the object already exists, and this mirror's job is to
	/// name it.
	/// </summary>
	/// <param name="batch">Batch this object's writes record into.</param>
	/// <param name="handle">Negative handle the JavaScript side registered the object under.</param>
	internal MeshMatcapNodeMaterial(ThreeBatch batch, int handle)
		: base(batch, handle)
	{
		Color = new Color(1f, 1f, 1f);
		Color.OnChange = () =>
	...
	/// <summary>Name of the corresponding three.js constructor, <c>THREE.MeshMatcapNodeMaterial</c>.</summary>
	protected override string ThreeTypeName
	{
		get { return "MeshMatcapNodeMaterial"; }
	}
	...
	/// the value <c>isMeshMatcapNodeMaterial</c> held.
	/// </summary>
	/// <returns>The value <c>isMeshMatcapNodeMaterial</c> held, once the JavaScript side has answered.</returns>
	public Task<bool> IsMeshMatcapNodeMaterialAsync()
	{
		return GetAsync<bool>("isMeshMatcapNodeMaterial");
	}

	/// <summary>
	/// Emits the create op for <c>THREE.MeshMatcapNodeMaterial</c>, then replays every property written
