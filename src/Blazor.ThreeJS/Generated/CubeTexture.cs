...
/// <remarks>
/// <see cref="CubeTexture"/> is almost equivalent in functionality and usage to <c>Texture</c>. The
/// only differences are that the images are an array of _6_ images as opposed to a single image,
/// and the mapping options are <c>THREE.CubeReflectionMapping</c> (default) or
/// <c>THREE.CubeRefractionMapping</c>.
/// </remarks>
...
public sealed class CubeTexture : EventDispatcher
{
	private CubeTextureMapping _mapping;
	...
	/// <summary>
	/// The <c>mapping</c> property of the JavaScript-side object. Writing it records a <c>mapping</c>
	/// property write once this object is attached; writing the value already held records nothing.
	/// </summary>
	public CubeTextureMapping Mapping
	{
		get { return _mapping; }
		set
		{
	...
	/// <summary>
	/// Emits the create op for <c>THREE.CubeTexture</c>, then replays every property written before
