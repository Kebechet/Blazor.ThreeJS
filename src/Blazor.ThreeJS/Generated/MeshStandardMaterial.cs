...
/// <summary>
/// A standard physically based material, using Metallic-Roughness workflow. Physically based
/// rendering (PBR) has recently become the standard in many 3D applications, such as
/// [Unity](https://blogs.unity3d.com/2014/10/29/physically-based-shading-in-unity-5-a-primer/),
/// [Unreal](https://docs.unrealengine.com/latest/INT/Engine/Rendering/Materials/PhysicallyBased/)
/// and [3D Studio
/// Max](http://area.autodesk.com/blogs/the-3ds-max-blog/what039s-new-for-rendering-in-3ds-max-2017).
/// This approach differs from older approaches in that instead of using approximations for the way
/// in which light interacts with a surface, a physically correct model is used. The idea is that,
/// instead of tweaking materials to look good under specific lighting, a material can be created
/// that will react 'correctly' under all lighting scenarios. In practice this gives a more accurate
/// and realistic looking result than the <see cref="MeshLambertMaterial"/> or
/// <see cref="MeshPhongMaterial"/>, at the cost of being somewhat more computationally expensive.
/// <c>MeshStandardMaterial</c> uses per-fragment shading. Note that for best results you should
/// always specify an environment map when using this material. For a non-technical introduction to
/// the concept of PBR and how to set up a PBR material, check out these articles by the people at
/// [marmoset](https://www.marmoset.co): - [Basic Theory of Physically Based
/// Rendering](https://www.marmoset.co/posts/basic-theory-of-physically-based-rendering/) -
/// [Physically Based Rendering and You Can
/// Too](https://www.marmoset.co/posts/physically-based-rendering-and-you-can-too/) Technical
/// details of the approach used in three.js (and most other PBR systems) can be found is this
/// [paper from
/// Disney](https://media.disneyanimation.com/uploads/production/publication_asset/48/asset/s2012_pbs_disney_brdf_notes_v3.pdf)
/// (pdf), by Brent Burley. The JavaScript-side <c>THREE.MeshStandardMaterial</c>.
/// </summary>
public class MeshStandardMaterial : Material
{
	...
	/// <summary>Constructs a new mesh standard material.</summary>
	...
	/// <summary>
	/// Adopts an existing JavaScript-side <c>MeshStandardMaterial</c> under the handle the browser
	/// minted for it. No create op is emitted: the object already exists, and this mirror's job is to
	/// name it.
	/// </summary>
	/// <param name="batch">Batch this object's writes record into.</param>
	/// <param name="handle">Negative handle the JavaScript side registered the object under.</param>
	internal MeshStandardMaterial(ThreeBatch batch, int handle)
		: base(batch, handle)
	{
		Color = new Color(1f, 1f, 1f);
		Color.OnChange = () =>
	...
	{
		get { return "MeshStandardMaterial"; }
	}
	...
	/// the value <c>isMeshStandardMaterial</c> held.
	/// </summary>
	/// <returns>The value <c>isMeshStandardMaterial</c> held, once the JavaScript side has answered.</returns>
	public Task<bool> IsMeshStandardMaterialAsync()
	{
		return GetAsync<bool>("isMeshStandardMaterial");
	}

	/// <summary>
	/// Emits the create op for <c>THREE.MeshStandardMaterial</c>, then replays every property written
