...
**41** of its constant groups, carrying 1943 public members and 252 enum members. Property names,
...
`partial class`. So `Generated/**` carries 1977 public members in all, and this headline claims
...
On the generated classes that reaches **482 members**:

- **378 answer with a value** - 207 methods (focal length and effective field of view, elapsed time,
