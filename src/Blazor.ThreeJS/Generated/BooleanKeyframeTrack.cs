...
/// <summary>A track for boolean keyframe values. The JavaScript-side <c>THREE.BooleanKeyframeTrack</c>.</summary>
public sealed class BooleanKeyframeTrack : ThreeObject
{
	...
	/// <summary>
	/// Constructs a new boolean keyframe track. This keyframe track type has no <c>interpolation</c>
	...
	public BooleanKeyframeTrack(string name, float[] times, bool[] values)
	{
		_name = name;
		_times = times;
		_values = values;
	...
	/// <summary>
	/// Adopts an existing JavaScript-side <c>BooleanKeyframeTrack</c> under the handle the browser
	/// minted for it. No create op is emitted: the object already exists, and this mirror's job is to
	/// name it.
	/// </summary>
	/// <param name="batch">Batch this object's writes record into.</param>
	/// <param name="handle">Negative handle the JavaScript side registered the object under.</param>
	internal BooleanKeyframeTrack(ThreeBatch batch, int handle)
		: base(handle)
	{
		_name = default!;
		_times = default!;
	...
	/// <summary>Name of the corresponding three.js constructor, <c>THREE.BooleanKeyframeTrack</c>.</summary>
	protected override string ThreeTypeName
	{
		get { return "BooleanKeyframeTrack"; }
	}

	/// <summary>
	/// Constructor arguments forwarded to <c>THREE.BooleanKeyframeTrack</c>: name, times, values.
	/// </summary>
	...
	public Task<BooleanKeyframeTrack?> OptimizeAsync()
	{
		return RecordReadObject<BooleanKeyframeTrack>("optimize", (adoptedBatch, adoptedHandle) => new BooleanKeyframeTrack(adoptedBatch, adoptedHandle));
	}
	...
	public Task<BooleanKeyframeTrack?> CloneAsync()
	{
		return RecordReadObject<BooleanKeyframeTrack>("clone", (adoptedBatch, adoptedHandle) => new BooleanKeyframeTrack(adoptedBatch, adoptedHandle));
	}

	/// <summary>
	/// Emits the create op for <c>THREE.BooleanKeyframeTrack</c>, then replays every property written
