...
/// <c>THREE.DirectionalLightShadow</c>.
/// </summary>
public sealed class DirectionalLightShadow : ThreeObject
{
	...
	/// <summary>Constructs a new directional light shadow.</summary>
	public DirectionalLightShadow()
	{
	}

	/// <summary>Name of the corresponding three.js constructor, <c>THREE.DirectionalLightShadow</c>.</summary>
	protected override string ThreeTypeName
	{
		get { return "DirectionalLightShadow"; }
	}
	...
	/// <summary>
	/// Emits the create op for <c>THREE.DirectionalLightShadow</c>, then replays every property written
