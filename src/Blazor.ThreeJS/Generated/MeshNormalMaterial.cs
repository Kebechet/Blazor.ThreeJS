...
/// <summary>
/// A material that maps the normal vectors to RGB colors. The JavaScript-side
/// <c>THREE.MeshNormalMaterial</c>.
/// </summary>
public sealed class MeshNormalMaterial : Material
{
	...
	/// <summary>Constructs a new mesh normal material.</summary>
	...
	/// <summary>
	/// Adopts an existing JavaScript-side <c>MeshNormalMaterial</c> under the handle the browser minted
	...
	internal MeshNormalMaterial(ThreeBatch batch, int handle)
		: base(batch, handle)
	{
		NormalScale = new Vector2();
		NormalScale.OnChange = () =>
	...
	/// <summary>Name of the corresponding three.js constructor, <c>THREE.MeshNormalMaterial</c>.</summary>
	protected override string ThreeTypeName
	{
		get { return "MeshNormalMaterial"; }
	}
	...
	/// the value <c>isMeshNormalMaterial</c> held.
	/// </summary>
	/// <returns>The value <c>isMeshNormalMaterial</c> held, once the JavaScript side has answered.</returns>
	public Task<bool> IsMeshNormalMaterialAsync()
	{
		return GetAsync<bool>("isMeshNormalMaterial");
	}

	/// <summary>
	/// Emits the create op for <c>THREE.MeshNormalMaterial</c>, then replays every property written
