...
| `WebGPURenderer` | `method getArrayBufferAsync` | `DomOrLibType` | return type: `ArrayBuffer` is a TypeScript lib type; C# holds no browser object and the wire format has no encoding for one |
