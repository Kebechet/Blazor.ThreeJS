...
/// <summary>
/// The shape three.js calls <c>CircleGeometryParameters</c>. A plain value rather than a
...
/// </summary>
public sealed record CircleGeometryParameters : IThreeStructure
{
	...
	/// <summary>
	/// Builds a <c>CircleGeometryParameters</c> from the members the applier sent back. A member
	...
	{
		return new CircleGeometryParameters
		{
