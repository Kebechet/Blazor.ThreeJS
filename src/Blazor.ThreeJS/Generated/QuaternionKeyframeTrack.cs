...
/// <summary>
/// A track for Quaternion keyframe values. The JavaScript-side
/// <c>THREE.QuaternionKeyframeTrack</c>.
/// </summary>
public sealed class QuaternionKeyframeTrack : ThreeObject
{
	...
	/// <summary>Constructs a new Quaternion keyframe track.</summary>
	...
	public QuaternionKeyframeTrack(string name, float[] times, float[] values, InterpolationModes? interpolation = null)
	{
		_name = name;
		_times = times;
		_values = values;
	...
	/// <summary>
	/// Adopts an existing JavaScript-side <c>QuaternionKeyframeTrack</c> under the handle the browser
	/// minted for it. No create op is emitted: the object already exists, and this mirror's job is to
	/// name it.
	/// </summary>
	/// <param name="batch">Batch this object's writes record into.</param>
	/// <param name="handle">Negative handle the JavaScript side registered the object under.</param>
	internal QuaternionKeyframeTrack(ThreeBatch batch, int handle)
		: base(handle)
	{
		_name = default!;
		_times = default!;
	...
	/// <summary>Name of the corresponding three.js constructor, <c>THREE.QuaternionKeyframeTrack</c>.</summary>
	protected override string ThreeTypeName
	{
		get { return "QuaternionKeyframeTrack"; }
	}

	/// <summary>
	/// Constructor arguments forwarded to <c>THREE.QuaternionKeyframeTrack</c>: name, times, values,
	...
	public Task<QuaternionKeyframeTrack?> OptimizeAsync()
	{
		return RecordReadObject<QuaternionKeyframeTrack>("optimize", (adoptedBatch, adoptedHandle) => new QuaternionKeyframeTrack(adoptedBatch, adoptedHandle));
	}
	...
	public Task<QuaternionKeyframeTrack?> CloneAsync()
	{
		return RecordReadObject<QuaternionKeyframeTrack>("clone", (adoptedBatch, adoptedHandle) => new QuaternionKeyframeTrack(adoptedBatch, adoptedHandle));
	}

	/// <summary>
	/// Emits the create op for <c>THREE.QuaternionKeyframeTrack</c>, then replays every property
