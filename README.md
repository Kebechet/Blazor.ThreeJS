...
**41** of its constant groups, carrying 1784 public members and 252 enum members. Property names,
...
`partial class`. So `Generated/**` carries 1818 public members in all, and this headline claims
...
On the generated classes that reaches **424 members**:

- **347 answer with a value** - 183 methods (focal length and effective field of view, elapsed time,
