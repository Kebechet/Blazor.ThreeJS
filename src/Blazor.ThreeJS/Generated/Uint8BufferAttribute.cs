...
/// <see href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array:">Uint8Array</see>
...
/// The JavaScript-side <c>THREE.Uint8BufferAttribute</c>.
/// </summary>
...
public sealed class Uint8BufferAttribute : BufferAttribute
{
	private readonly Uint8Array _array;
	private readonly float _itemSize;
	private readonly bool _normalized;

	/// <summary>This creates a new <c>Uint8BufferAttribute</c> object.</summary>
	/// <param name="array">
	/// This can be a typed or untyped (normal) array or an integer length. An array value will be
	/// converted to <c>Uint8Array</c>. If a length is given a new <c>TypedArray</c> will created,
	...
	/// </param>
	public Uint8BufferAttribute(Uint8Array array, float itemSize, bool normalized = false)
	...
	/// <summary>
	/// Adopts an existing JavaScript-side <c>Uint8BufferAttribute</c> under the handle the browser
	/// minted for it. No create op is emitted: the object already exists, and this mirror's job is to
	/// name it.
	/// </summary>
	/// <param name="batch">Batch this object's writes record into.</param>
	/// <param name="handle">Negative handle the JavaScript side registered the object under.</param>
	internal Uint8BufferAttribute(ThreeBatch batch, int handle)
		: base(batch, handle)
	{
		_array = default!;
		_itemSize = default!;
	...
	/// <summary>Name of the corresponding three.js constructor, <c>THREE.Uint8BufferAttribute</c>.</summary>
	protected override string ThreeTypeName
	{
		get { return "Uint8BufferAttribute"; }
	}

	/// <summary>
	/// Constructor arguments forwarded to <c>THREE.Uint8BufferAttribute</c>: array, itemSize,
	/// normalized.
	/// </summary>
