...
/// <summary>
/// The shape three.js calls <c>WebGLInfoMemory</c>. A plain value rather than a handle-backed
...
/// </summary>
public sealed record WebGLInfoMemory : IThreeStructure
{
	...
	/// <summary>
	/// Builds a <c>WebGLInfoMemory</c> from the members the applier sent back. A member three.js did
