...
/// <summary>
/// A material for drawing geometries in a simple shaded (flat or wireframe) way. This material is
/// not affected by lights. The JavaScript-side <c>THREE.MeshBasicMaterial</c>.
/// </summary>
public sealed class MeshBasicMaterial : Material
{
	...
	/// <summary>Constructs a new mesh basic material.</summary>
	...
	/// <summary>
	/// Adopts an existing JavaScript-side <c>MeshBasicMaterial</c> under the handle the browser minted
	...
	internal MeshBasicMaterial(ThreeBatch batch, int handle)
		: base(batch, handle)
	{
		Color = new Color(1f, 1f, 1f);
		Color.OnChange = () =>
	...
	/// <summary>Name of the corresponding three.js constructor, <c>THREE.MeshBasicMaterial</c>.</summary>
	protected override string ThreeTypeName
	{
		get { return "MeshBasicMaterial"; }
	}
	...
	/// the value <c>isMeshBasicMaterial</c> held.
	/// </summary>
	/// <returns>The value <c>isMeshBasicMaterial</c> held, once the JavaScript side has answered.</returns>
	public Task<bool> IsMeshBasicMaterialAsync()
	{
		return GetAsync<bool>("isMeshBasicMaterial");
	}

	/// <summary>
	/// Emits the create op for <c>THREE.MeshBasicMaterial</c>, then replays every property written
