...
/// The JavaScript-side <c>THREE.Float16BufferAttribute</c>.
/// </summary>
...
public sealed class Float16BufferAttribute : BufferAttribute
{
	private readonly Uint16Array _array;
	private readonly float _itemSize;
	private readonly bool _normalized;

	/// <summary>This creates a new <c>Float16BufferAttribute</c> object.</summary>
	/// <param name="array">
	...
	/// </param>
	public Float16BufferAttribute(Uint16Array array, float itemSize, bool normalized = false)
	...
	/// <summary>
	/// Adopts an existing JavaScript-side <c>Float16BufferAttribute</c> under the handle the browser
	/// minted for it. No create op is emitted: the object already exists, and this mirror's job is to
	/// name it.
	/// </summary>
	/// <param name="batch">Batch this object's writes record into.</param>
	/// <param name="handle">Negative handle the JavaScript side registered the object under.</param>
	internal Float16BufferAttribute(ThreeBatch batch, int handle)
		: base(batch, handle)
	{
		_array = default!;
		_itemSize = default!;
	...
	/// <summary>Name of the corresponding three.js constructor, <c>THREE.Float16BufferAttribute</c>.</summary>
	protected override string ThreeTypeName
	{
		get { return "Float16BufferAttribute"; }
	}

	/// <summary>
	/// Constructor arguments forwarded to <c>THREE.Float16BufferAttribute</c>: array, itemSize,
	/// normalized.
	/// </summary>
