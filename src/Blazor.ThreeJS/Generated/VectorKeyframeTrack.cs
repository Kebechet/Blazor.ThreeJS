...
/// <summary>A track for vector keyframe values. The JavaScript-side <c>THREE.VectorKeyframeTrack</c>.</summary>
public sealed class VectorKeyframeTrack : ThreeObject
{
	...
	/// <summary>Constructs a new vector keyframe track.</summary>
	...
	public VectorKeyframeTrack(string name, float[] times, float[] values, InterpolationModes? interpolation = null)
	{
		_name = name;
		_times = times;
		_values = values;
	...
	/// <summary>
	/// Adopts an existing JavaScript-side <c>VectorKeyframeTrack</c> under the handle the browser
	/// minted for it. No create op is emitted: the object already exists, and this mirror's job is to
	/// name it.
	/// </summary>
	/// <param name="batch">Batch this object's writes record into.</param>
	/// <param name="handle">Negative handle the JavaScript side registered the object under.</param>
	internal VectorKeyframeTrack(ThreeBatch batch, int handle)
		: base(handle)
	{
		_name = default!;
		_times = default!;
	...
	/// <summary>Name of the corresponding three.js constructor, <c>THREE.VectorKeyframeTrack</c>.</summary>
	protected override string ThreeTypeName
	{
		get { return "VectorKeyframeTrack"; }
	}

	/// <summary>
	/// Constructor arguments forwarded to <c>THREE.VectorKeyframeTrack</c>: name, times, values,
	...
	public Task<VectorKeyframeTrack?> OptimizeAsync()
	{
		return RecordReadObject<VectorKeyframeTrack>("optimize", (adoptedBatch, adoptedHandle) => new VectorKeyframeTrack(adoptedBatch, adoptedHandle));
	}
	...
	public Task<VectorKeyframeTrack?> CloneAsync()
	{
		return RecordReadObject<VectorKeyframeTrack>("clone", (adoptedBatch, adoptedHandle) => new VectorKeyframeTrack(adoptedBatch, adoptedHandle));
	}

	/// <summary>
	/// Emits the create op for <c>THREE.VectorKeyframeTrack</c>, then replays every property written
