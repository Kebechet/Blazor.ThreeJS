...
/// <summary>A basic linear interpolant. The JavaScript-side <c>THREE.LinearInterpolant</c>.</summary>
public sealed class LinearInterpolant : ThreeObject
{
	...
	/// <summary>Initializes a new <see cref="LinearInterpolant"/>.</summary>
	...
	/// <summary>
	/// Adopts an existing JavaScript-side <c>LinearInterpolant</c> under the handle the browser minted
	...
	internal LinearInterpolant(ThreeBatch batch, int handle)
		: base(handle)
	{
	...
	/// <summary>Name of the corresponding three.js constructor, <c>THREE.LinearInterpolant</c>.</summary>
	protected override string ThreeTypeName
	{
		get { return "LinearInterpolant"; }
	}

	/// <summary>
	/// Constructor arguments forwarded to <c>THREE.LinearInterpolant</c>: parameterPositions,
	...
	/// <summary>
	/// Emits the create op for <c>THREE.LinearInterpolant</c>, then replays every property written
