...
/// <summary>
/// The shape three.js calls <c>CompressedTextureImageData</c>. A plain value rather than a
...
/// </summary>
public sealed record CompressedTextureImageData : IThreeStructure
{
	...
	/// <summary>
	/// Builds a <c>CompressedTextureImageData</c> from the members the applier sent back. A member
	...
	{
		return new CompressedTextureImageData
		{
