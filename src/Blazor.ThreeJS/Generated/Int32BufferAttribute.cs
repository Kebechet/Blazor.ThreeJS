...
/// <see href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Int32Array:">Int32Array</see>
...
/// The JavaScript-side <c>THREE.Int32BufferAttribute</c>.
/// </summary>
...
public sealed class Int32BufferAttribute : BufferAttribute
{
	private readonly Int32Array _array;
	private readonly float _itemSize;
	private readonly bool _normalized;

	/// <summary>This creates a new <c>Int32BufferAttribute</c> object.</summary>
	/// <param name="array">
	/// This can be a typed or untyped (normal) array or an integer length. An array value will be
	/// converted to <c>Int32Array</c>. If a length is given a new <c>TypedArray</c> will created,
	...
	/// </param>
	public Int32BufferAttribute(Int32Array array, float itemSize, bool normalized = false)
	...
	/// <summary>
	/// Adopts an existing JavaScript-side <c>Int32BufferAttribute</c> under the handle the browser
	/// minted for it. No create op is emitted: the object already exists, and this mirror's job is to
	/// name it.
	/// </summary>
	/// <param name="batch">Batch this object's writes record into.</param>
	/// <param name="handle">Negative handle the JavaScript side registered the object under.</param>
	internal Int32BufferAttribute(ThreeBatch batch, int handle)
		: base(batch, handle)
	{
		_array = default!;
		_itemSize = default!;
	...
	/// <summary>Name of the corresponding three.js constructor, <c>THREE.Int32BufferAttribute</c>.</summary>
	protected override string ThreeTypeName
	{
		get { return "Int32BufferAttribute"; }
	}

	/// <summary>
	/// Constructor arguments forwarded to <c>THREE.Int32BufferAttribute</c>: array, itemSize,
	/// normalized.
	/// </summary>
