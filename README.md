...
one of those 194 classes - its command and query surface is emitted as the other half of a
`partial class`. So `Generated/**` carries 1769 public members in all, and this headline claims
