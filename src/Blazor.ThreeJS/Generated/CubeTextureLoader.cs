...
/// <summary>The JavaScript-side <c>THREE.CubeTextureLoader</c>.</summary>
public sealed class CubeTextureLoader : Loader
{
	...
	/// <summary>
	/// Adopts an existing JavaScript-side <c>CubeTextureLoader</c> under the handle the browser minted
	...
	internal CubeTextureLoader(ThreeBatch batch, int handle)
		: base(batch, handle)
	{
		Batch = batch;
	}

	/// <summary>Name of the corresponding three.js constructor, <c>THREE.CubeTextureLoader</c>.</summary>
	protected override string ThreeTypeName
	{
		get { return "CubeTextureLoader"; }
	}

	/// <summary>
	/// Constructor arguments forwarded to <c>THREE.CubeTextureLoader</c>: manager. An argument the
	...
	/// <summary>
	/// Attaches the objects <c>THREE.CubeTextureLoader</c> is constructed from, so their create ops
