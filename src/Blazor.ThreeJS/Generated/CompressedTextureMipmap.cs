...
/// <summary>
/// The shape three.js calls <c>CompressedTextureMipmap</c>. A plain value rather than a
...
/// </summary>
public sealed record CompressedTextureMipmap : IThreeStructure
{
	/// <summary>three.js's <c>data</c>.</summary>
	public TypedArray Data { get; init; }
	...
	/// <summary>
	/// Builds a <c>CompressedTextureMipmap</c> from the members the applier sent back. A member
