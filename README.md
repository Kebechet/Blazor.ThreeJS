...
Generated from `@types/three@0.185.3`: **215 of three.js's 309 core classes** and
**41** of its constant groups, carrying 1885 public members and 252 enum members. Property names,
...
one of those 215 classes - its command and query surface is emitted as the other half of a
`partial class`. So `Generated/**` carries 1919 public members in all, and this headline claims
only the ones that sit on a class the generator made.

A further 49 classes have no generated type and are still **reachable** untyped, by name -
...
|---|---|
| **generated** | **215** |
| blocked on something the mirror cannot express yet | 41 |
...
The 41 blocked classes account for themselves as follows:
...
- **15 are absent from the shipped three.js bundle.** Not a mapping decision: `THREE[name]` is
  ...
  escape hatch either.
- **15 lose no capability**, listed below. They are abstract bases whose concrete subclasses all
...
- **53 of the 215 generated classes have a narrower constructor.** 94 trailing optional parameters
...
| | classes |
|---|---|
| **generated, and typed** | **215** |
| reachable by name, untyped | 49 |
