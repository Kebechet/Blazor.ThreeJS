...
**41** of its constant groups, carrying 1731 public members and 252 enum members. Property names,
...
On the generated classes that reaches **438 members**, each emitted as `…Async` returning a `Task<T>`:
...
- **174 read-only properties** - `uuid`, `instanceCount`, `unusedVertexCount`, and three.js's own
