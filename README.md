...
**47** of its constant groups, carrying 2289 public members and 294 enum members. Property names,
...
`partial class`. So `Generated/**` carries 2326 public members in all, and this headline claims
...
On the generated classes that reaches **551 members**:

- **435 answer with a value** - 249 methods (focal length and effective field of view, elapsed time,
...
- **56 of the 227 generated classes have a narrower constructor.** 84 trailing optional parameters
