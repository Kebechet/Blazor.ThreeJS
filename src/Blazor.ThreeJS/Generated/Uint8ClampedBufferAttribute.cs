...
/// <see href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8ClampedArray:">Uint8ClampedArray</see>
...
/// The JavaScript-side <c>THREE.Uint8ClampedBufferAttribute</c>.
/// </summary>
...
public sealed class Uint8ClampedBufferAttribute : BufferAttribute
{
	private readonly Uint8ClampedArray _array;
	private readonly float _itemSize;
	private readonly bool _normalized;

	/// <summary>This creates a new <c>Uint8ClampedBufferAttribute</c> object.</summary>
	/// <param name="array">
	/// This can be a typed or untyped (normal) array or an integer length. An array value will be
	/// converted to <c>Uint8ClampedArray</c>. If a length is given a new <c>TypedArray</c> will
	...
	/// </param>
	public Uint8ClampedBufferAttribute(Uint8ClampedArray array, float itemSize, bool normalized = false)
	...
	/// <summary>
	/// Adopts an existing JavaScript-side <c>Uint8ClampedBufferAttribute</c> under the handle the
	...
	internal Uint8ClampedBufferAttribute(ThreeBatch batch, int handle)
		: base(batch, handle)
	{
		_array = default!;
		_itemSize = default!;
	...
	/// <summary>Name of the corresponding three.js constructor, <c>THREE.Uint8ClampedBufferAttribute</c>.</summary>
	protected override string ThreeTypeName
	{
		get { return "Uint8ClampedBufferAttribute"; }
	}

	/// <summary>
	/// Constructor arguments forwarded to <c>THREE.Uint8ClampedBufferAttribute</c>: array, itemSize,
	/// normalized.
	/// </summary>
