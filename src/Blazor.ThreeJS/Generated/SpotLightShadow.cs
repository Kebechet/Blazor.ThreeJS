...
/// <summary>
/// Represents the shadow configuration of directional lights. The JavaScript-side
/// <c>THREE.SpotLightShadow</c>.
/// </summary>
public sealed class SpotLightShadow : ThreeObject
{
	...
	/// <summary>Constructs a new spot light shadow.</summary>
	public SpotLightShadow()
	{
	}

	/// <summary>Name of the corresponding three.js constructor, <c>THREE.SpotLightShadow</c>.</summary>
	protected override string ThreeTypeName
	{
		get { return "SpotLightShadow"; }
	}

	/// <summary>
	/// Used to focus the shadow camera. The camera's field of view is set as a percentage of the
	/// spotlight's field-of-view. Range is <c>[0, 1]</c>. Writing it records a <c>focus</c> property
	...
	/// <summary>
	/// Texture aspect ratio. Writing it records a <c>aspect</c> property write once this object is
	...
	public void Copy(SpotLightShadow source)
	{
