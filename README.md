...
**44** of its constant groups, carrying 2229 public members and 263 enum members. Property names,
...
`partial class`. So `Generated/**` carries 2265 public members in all, and this headline claims
...
On the generated classes that reaches **541 members**:
...
- **104 answer with a mirrored object** - `Task<T?>` over the generated type, adopted under the handle the
