...
**44** of its constant groups, carrying 2180 public members and 263 enum members. Property names,
...
`partial class`. So `Generated/**` carries 2214 public members in all, and this headline claims
...
On the generated classes that reaches **529 members**:

- **421 answer with a value** - 238 methods (focal length and effective field of view, elapsed time,
