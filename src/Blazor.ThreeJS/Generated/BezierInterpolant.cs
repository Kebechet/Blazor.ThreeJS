...
/// <summary>
/// A Bezier interpolant using cubic Bezier curves with 2D control points. This interpolant supports
/// the COLLADA/Maya style of Bezier animation where each keyframe has explicit in/out tangent
/// control points specified as 2D coordinates (time, value). Tangent data is read from
/// <c>inTangents</c> and <c>outTangents</c> on the interpolant (populated by
/// <c>KeyframeTrack.InterpolantFactoryMethodBezier</c>). For a track with N keyframes and stride S:
/// - Each tangent array has N * S * 2 values - Layout: [k0_c0_time, k0_c0_value, k0_c1_time,
/// k0_c1_value, ..., k0_cS_time, k0_cS_value, k1_c0_time, k1_c0_value, ...]. The JavaScript-side
/// <c>THREE.BezierInterpolant</c>.
/// </summary>
public sealed class BezierInterpolant : ThreeObject
{
	...
	/// <summary>Initializes a new <see cref="BezierInterpolant"/>.</summary>
	...
	/// <summary>
	/// Adopts an existing JavaScript-side <c>BezierInterpolant</c> under the handle the browser minted
	...
	internal BezierInterpolant(ThreeBatch batch, int handle)
		: base(handle)
	{
	...
	/// <summary>Name of the corresponding three.js constructor, <c>THREE.BezierInterpolant</c>.</summary>
	protected override string ThreeTypeName
	{
		get { return "BezierInterpolant"; }
	}

	/// <summary>
	/// Constructor arguments forwarded to <c>THREE.BezierInterpolant</c>: parameterPositions,
	...
	/// <summary>Optional method that is executed when the interval has changed.</summary>
	/// <param name="i1">An index into the sample value buffer.</param>
	/// <param name="t0">The previous interpolation factor.</param>
	/// <param name="t">The current interpolation factor.</param>
	public void IntervalChanged_(float i1, float t0, float t)
	{
		RecordCall("intervalChanged_", i1, t0, t);
	}
	...
	/// <summary>
	/// Emits the create op for <c>THREE.BezierInterpolant</c>, then replays every property written
