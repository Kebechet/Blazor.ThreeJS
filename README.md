...
Generated from `@types/three@0.185.3`: **209 of three.js's 309 core classes** and
**41** of its constant groups, carrying 1806 public members and 252 enum members. Property names,
...
one of those 209 classes - its command and query surface is emitted as the other half of a
`partial class`. So `Generated/**` carries 1840 public members in all, and this headline claims
only the ones that sit on a class the generator made.

A further 55 classes have no generated type and are still **reachable** untyped, by name -
...
On the generated classes that reaches **435 members**:

- **358 answer with a value** - 183 methods (focal length and effective field of view, elapsed time,
...
- **10 are neither**, and are a genuine gap nobody has written a route to yet.
...
- **53 of the 209 generated classes have a narrower constructor.** 94 trailing optional parameters
...
| | classes |
|---|---|
| **generated, and typed** | **209** |
| reachable by name, untyped | 55 |
